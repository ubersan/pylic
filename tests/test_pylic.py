...
def test_all_licenses_ok_if_no_packages_installed_or_whitelisted_and_no_liceses_safe():
    all_licenses_ok = check_licenses(safe_licenses=[], whitelisted_packages=[], installed_licenses=[])
